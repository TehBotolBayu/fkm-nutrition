...
const Page = () => {
  return (
    <div className="mt-20 ">
      ...
      <section id="contact" className="relative py-20 md:py-[120px] text-left">
        <div className="absolute top-0 left-0 -z-[1] w-full dark:bg-dark h-full" />
        <div className="absolute top-0 left-0 -z-[1] h-1/2 w-full bg-[#E9F9FF] dark:bg-dark-700 lg:h-[45%] xl:h-1/2" />
          ...
          <div className="flex flex-wrap items-center -mx-4">
            <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
              <div className="ud-contact-content-wrapper">
                ...
                <div className="flex flex-wrap justify-evenly mb-12 lg:mb-0 ">
                  <div className="mb-8 flex w-[330px] max-w-full">
                    ...
                    <div>
                      ...
                      <p className="text-base text-body-color dark:text-dark-6">
                        Jl. Sambaliung, Gn. Kelua, Kec. Samarinda Utara, Kota
                  ...
                  <div className="mb-8 flex w-[330px] max-w-full">
                    ...
                    <div>
                      ...
                      <p className="text-base text-body-color dark:text-dark-6 text-wrap ">
                        nutrition.fkm.unmul.pkmbima2024@gmail.com
                      </p>
                    </div>
                  </div>
                </div>
